...
function addSuccessModal() {
  document.body.appendChild(getCopySuccess());
  const modal = document.querySelector(".success");
  
  changeModalBackground(modal)
}

function changeModalBackground(modal) {
    const colors = ["#dce3e9b0", "#dce3e990", "#dce3e96d", "#dce3e957", "#dce3e940", "#dce3e92e", "#dce3e91f", "#dce3e910"]
